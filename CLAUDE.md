...
| ② **홀드아웃 = 코퍼스에 없는 회차**(13회차) | 무료 경로 일반화 | P 92 R 86 **F1 88.7** |
| ③ **실기 비전 ON 블라인드** | **이것이 목표 대상** | **7회차 전원 F1 100**(80아이템·FP 0·FN 0) |

**①이 100이어도 목표 달성이 아니다.** 실제로 ①이 97.9일 때 ②는 47.1이었다(§100). 진척을 보고할 때는 반드시 ②·③을 함께 적을 것.

③의 7회차 중 6/01·6/04는 그 회차 FP로 프롬프트를 고친 in-sample이다 — 일반화 근거는 5/11·5/07 두 회차(§119).
