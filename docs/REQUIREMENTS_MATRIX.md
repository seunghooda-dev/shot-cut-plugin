...
## 원래 후순위였던 요구사항의 현재 상태

원래 13단계 이후로 분류했던 항목 중 다수가 2026-07-13~16 사용자 지시로 당겨져 출시됐다.
§ 참조는 [아카이브 런북](HOST_BETA_RUNBOOK_ARCHIVE.md) 기준이다.

| 요구사항 | 처리 |
|---|---|
| AI 이미지·영상 생성 파이프라인 | **출시 완료**(2026-07-13~14, 아카이브 §29~§33) — 레퍼런스 이미지 생성·영상 생성, 4K 업스케일 제외 |
| BGM 비트 스냅·자동 덕킹 | **출시 완료**(2026-07-14, 아카이브 §35·B1) |
| 다국어 패키지 | v1(번역 SRT+메타) **출시 완료**(2026-07-15, 아카이브 §49-d) — TTS 더빙은 2026-07-16 사용자 지시로 영구 제외 |
| 스마트 리프레임·피사체 추적 | **출시 완료**(2026-07-15, 아카이브 §38·§41·§44·§47) |
| 플랫폼별 업로드 패키지 생성 | **출시 완료**(2026-07-15, 아카이브 §49-d) |
| 뉴스 분할(News Cut) | **출시 완료·첫 번째 탭**(2026-07-15~16, 아카이브 §52~§54) — 이후 원클릭 무료화·AI 비전 검증·실기 43회차 중 42회차 F1 100(누적치, 현행 런북 §133~§177). 회귀 게이트는 `npm run check:news` |
| 자막 버전 스냅샷 | **출시 완료**(2026-07-15, 아카이브 §49) |
| 썸네일 AI 대화 수정 | **출시 완료**(2026-07-13 사용자 지시로 활성) |
...
| 다국어 TTS 더빙 | **영구 제외**(2026-07-16 사용자 지시) |
