...
const DEFAULT_HOLDOUT = ["Train_KBC_20260709_Thu", "Train_KBC_20260711_Sat", "Train_KBC_20260712_Sun", "Train_KBC_20260628_Sun", "Train_KBC_20260723_Thu", "Train_KBC_20260724_Fri", "Train_KBC_20260725_Sat", "Train_KBC_20260520_Wed", "Train_KBC_20260527_Wed", "Train_KBC_20260726_Sun", "Train_KBC_20260601_Mon", "Train_KBC_20260604_Thu", "Train_KBC_20260511_Mon", "Train_KBC_20260508_Fri", "Train_KBC_20260507_Thu",
  ...
  // §151(2026-07-30) 블라인드 소진 5회차 등록분(1/15·3/12·3/18·4/23·2/19) 중 셋을 홀드아웃에
  // 남긴다 — 3/12·4/23(각각 3·4월 대표), 2/19(60fps 소스 유일 표본). 1/15·3/18은 학습으로.
  "Train_KBC_20260312_Thu", "Train_KBC_20260423_Thu", "Train_KBC_20260219_Thu",
  // §157(2026-07-30) 신규 미학습 3회차 — 7/27·7/28은 실기 3실행 전부 100(완료 조건 1번의
  // 2회차 확보), 7/29는 코퍼스에 없던 "데스크 칼럼" 포맷에서 3실행 모두 82.8로 일관 오판.
  // 셋 다 홀드아웃에 남긴다 — 특히 7/29를 학습셋으로 삼키면 새 포맷의 실패가 ②에서 사라진다.
  "Train_KBC_20260727_Mon", "Train_KBC_20260728_Tue", "Train_KBC_20260729_Wed",
  // §177(2026-08-03) 신규 미학습 4회차 — 7/30·7/31·8/1·8/2 전부 실기 복수 실행 100(③ 소진분).
  // 전부 홀드아웃 — 8월 초 분포의 일반화 신호를 ②에 남긴다(학습셋 편입은 §151 원칙대로
  // 대표성 필요가 생길 때만).
  "Train_KBC_20260730_Thu", "Train_KBC_20260731_Fri", "Train_KBC_20260801_Sat", "Train_KBC_20260802_Sun"];
const SWEEP = [
